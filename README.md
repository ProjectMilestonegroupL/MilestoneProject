...
**We provide three CSV files in the zip `Milestone1 groupL`. You can alternatively fount it [here](https://github.com/ProjectMilestonegroupL/MilestoneProject/blob/main/Milestone1) into a zip.**
